				...
				<div class="admin-wrapper">
					<form action="" method="post" enctype="multipart/form-data">
						<?php
							...
							$id_product = $_GET["updateid"];
							$sql = "SELECT * FROM add_product WHERE id_product='$id_product'";
							...
							if (isset($_POST['submit'])) {
								...
								if (count($errors)>0) {
									...
									move_uploaded_file($tmp_name, "ImageProduk/".$new_foto_name);
									$sql = "UPDATE add_product set id_product='$id_product', nama_produk='$nama_produk', harga='$harga', kategori='$kategori', date_exp='$date_exp', foto_produk='$new_foto_name' WHERE id_product='$id_product'";
									$result = mysqli_query($connect, $sql);

									if ($result) {
										echo "<div class='alert alert-success'>The product update was successfully added</div>";
										header("Location: karyawanProduct.php");
									} else {
						...
						<div class="form-group">
					    	...
					    	<input type="text" class="form-control" name="nama_produk" placeholder="Nama produk" autocomplete="off" value="<?php echo $nama_produk; ?>">
					 	</div><br>
					  	<div class="form-group">
					    	<label>Harga</label>
					    	<input type="Text" class="form-control" name="harga" placeholder="Harga" autocomplete="off" value="<?php echo $harga; ?>">
					  	</div><br>
					  	<div class="form-group">
					    	<label>Kategori</label>
					    	<input type="text" class="form-control" name="kategori"  placeholder="Kategori" autocomplete="off" value="<?php echo $kategori; ?>">
					 	</div><br>
					 	<div class="form-group">
					  	...
					  	<div class="form-group">
					    	...
					    	<input type="date" class="form-control" name="date_exp" 	autocomplete="off" value="<?php echo $date_exp; ?>">
					  	</div><br>
					  	<button type="submit" class="btn btn-primary" name="submit">Update</button>
					  	<a href="karyawanProduct.php" class="btn btn-danger">Cancel</a>
					</form>
				</div>
			</div>
		</div>
